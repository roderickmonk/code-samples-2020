...
export class ConfigGenerator {
    ...
    /*
    ConfigGenerator works from conveniently composed configuration structure and 
    explodes it out to multiple configuration structures, one per simulation run.
    It is written in TypeScript and uses a JS generator to yield the results back
